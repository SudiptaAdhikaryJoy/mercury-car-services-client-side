...
const services = [
    ...
    { id: 2, name: 'Lube, Oil and Filters', description: 'Oil is responsible for lubricating the working components inside your vehicles engine while reducing the amount of friction between them. Together, the oil and oil filter keep your vehicles engine operating at optimal levels of performance.', image: 'https://www.eurocarparts.com/blog/ecp-wp-content/uploads/2016/07/Engine-Oil-Pour.jpg', price: 1500},
    { id: 3, name: 'Belts and Hoses', description: 'Your vehicles belts and hoses are involved in processes within the cooling system, air conditioning system, charging system, and engine. The heater hose and radiator hose carry liquid coolant to and from the engine, radiator, and heater core.', image: 'https://kingsquicklane.com/wp-content/uploads/2018/12/Belts-and-Hoses-Cincinnati-OH-Belt-System.jpg', price: 2100},
    { id: 4, name:'Air Conditioning', description: 'Air conditioning, often abbreviated as A/C or AC, is the process of removing heat and controlling the humidity of air in an enclosed space to achieve a more comfortable interior environment by use of powered "air conditioners" or a variety of other methods, including passive cooling and ventilative cooling.', image: 'https://thumbs.dreamstime.com/b/auto-mechanic-diagnosing-car-service-red-uniform-hoist-134182845.jpg', price: 2500}
]
